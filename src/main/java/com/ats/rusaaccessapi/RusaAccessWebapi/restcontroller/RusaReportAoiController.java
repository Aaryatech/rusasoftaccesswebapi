...
public class RusaReportAoiController {
	 ...
	 * 
	 * try { progTypeList =
	 * programTypeRepo.findByDelStatusAndIsActiveAndSequenceNotIn(1 , 1, "0");
	 * 
	 * } catch (Exception e) { System.err.println("Exce in getAllProgramType  " +
	 ...
	 * 
	 * @RequestMapping(value = { "/getProgramByProgramTypeId" }, method =
	 * RequestMethod.POST) public @ResponseBody List<Program>
	 * getProgramByProgramTypeId(@RequestParam("programTypeId") int
	 * programTypeId,@RequestParam("instituteId") int instituteId ) {
	 * 
	 ...
	 * 
	 * list =
	 * programRepository.findByProgramTypeAndDelStatusAndInstituteId(programTypeId,
	 * 1, instituteId);
	 * 
	 * } catch (Exception e) {
	 * 
